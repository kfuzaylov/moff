...
describe('AMD', function () {
	...
	Moff.amd.register({
		...
		beforeInclude: function beforeInclude() {
			before = true;
		},
		afterInclude: function afterInclude() {
			after = true;
		},
	...
	describe('Moff.register method', function () {
		...
		it('registers new module', function () {
			expect(_typeof(Moff.amd._testonly._registeredFiles.fakeId)).toEqual('object');
		});

		it('normalizes registered object', function () {
			expect(Moff.amd._testonly._registeredFiles.fakeId.loaded).toBe(false);

			expect(_typeof(Moff.amd._testonly._registeredFiles.fakeId.depend)).toEqual('object');
			...
			expect(_typeof(Moff.amd._testonly._registeredFiles.fakeId.file)).toEqual('object');
...
describe('Moff Detect', function () {
	describe('HTML5 supports', function () {
		...
		it('audio feature', function () {
			expect(_typeof(Moff.detect.audio)).toEqual('object');
		...
		it('video feature', function () {
			expect(_typeof(Moff.detect.video)).toEqual('object');
...
describe('Moff.modules API', function () {
	...
	describe('Moff.modules.create', function () {
		...
		it('registers constructor and dependency files', function () {
			expect(_typeof(Moff.modules._testonly._moduleClassStorage.Slideshow.constructor)).toEqual('function');
			expect(_typeof(Moff.modules._testonly._moduleClassStorage.Slideshow.depend)).toEqual('object');
		});
	...
	describe('Moff.modules.get', function () {
		...
		it('gets module class object by name', function () {
			expect(typeof moduleObject === 'undefined' ? 'undefined' : _typeof(moduleObject)).toEqual('object');
			Moff.modules.initClass('Module2', { id: 'modId' });
	...
	describe('Moff.modules.remove', function () {
		it('removes all objects by class name', function () {
			...
			expect(_typeof(Moff.modules.get('Module2'))).toEqual('object');
			Moff.modules.remove('Module2');
...
describe('Moff.Module Base Class', function () {
	...
	describe('Initialized module class', function () {
		...
		it('has find method to search inside module scope', function () {
			expect(_typeof(testObject.find)).toEqual('function');
		...
		it('has scope property', function () {
			...
			expect(_typeof(moduleObject.scope)).toEqual('object');
		});
		...
		it('has beforeInit, afterInit and init hooks', function () {
			expect(_typeof(testObject.beforeInit)).toEqual('function');
			expect(_typeof(testObject.afterInit)).toEqual('function');
			expect(_typeof(testObject.init)).toEqual('function');
		});
	});
	...
	describe('Moff.Module.reopen method', function () {
		...
		it('adds new methods and properties', function () {
			...
			expect(_typeof(test.newMethod)).toEqual('function');
